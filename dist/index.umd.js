...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PlacesAutocomplete = function (_Component) {
	  ...
	  _createClass(PlacesAutocomplete, [{
	    ...
	    key: 'selectAddress',
	    value: function selectAddress(address, placeId, name, e) {
	      if (e !== undefined) {
	        e.preventDefault();
	      }
	    ...
	    key: 'handleSelect',
	    value: function handleSelect(address, placeId, name) {
	      this.props.onSelect ? this.props.onSelect(address, placeId, name) : this.props.inputProps.onChange(address);
	    }
	  }, {
	    key: 'getActiveItem',
	    ...
	    value: function handleEnterKey() {
	      ...
	      if (activeItem === undefined) {
	        ...
	        this.selectAddress(activeItem.suggestion, activeItem.placeId, activeItem.formattedSuggestion.mainText);
	      }
	    }
	  }, {
	    ...
	    value: function handleSuggestionClick(prediction, event) {
	      ...
	      var suggestion = prediction.suggestion,
	          ...
	          formattedSuggestion = prediction.formattedSuggestion;
	
	      this.selectAddress(suggestion, placeId, formattedSuggestion.mainText, event);
	      setTimeout(function () {
